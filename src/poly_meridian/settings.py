...
class Settings(BaseSettings):
    ...
    # FROZEN (operator decision): LLM disabled by default to stop Claude
    # API spend. Set LLM_RESOLVER_ENABLED=true env var to re-enable when
    # ready to resume. Daily budget kept tight as a second safety net.
    ...
    # Hard budget cap reduced to $0.10/day as a belt-and-suspenders guard
    # in case anything else flips llm_resolver_enabled back on by accident.
    llm_resolver_daily_budget_usd: float = 0.10
